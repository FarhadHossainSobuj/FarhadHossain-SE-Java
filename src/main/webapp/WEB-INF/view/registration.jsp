...
<html lang="en">
  ...
  <body>    
	...
	<div class="container">
		...
		<form id="login-form" class="text-left" method="post" action="save-user">
			...
			<div class="main-login-form">
				<div class="login-group">
					...
					<div class="form-group">
						<label for="lg_username" class="sr-only">Age</label>
				...
				<button type="submit" class="login-button btn-primary">Submit</button>
			</div>
